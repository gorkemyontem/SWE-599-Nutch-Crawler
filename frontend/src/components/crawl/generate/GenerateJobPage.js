...
export function GenerateJobPage({
    jobs,
    loadJobs,
    config,
    loadConfig,
...
export default connect(mapStateToProps, mapDispatchToProps)(GenerateJobPage);
